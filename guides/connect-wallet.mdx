...
description: Build a wallet connection interface with use-wallet
---

This guide demonstrates how to build a wallet connection interface using use-wallet. Being a headless library, use-wallet gives you complete control over your wallet UI implementation.
...
- Optional: Add network selection (see [Switching networks](/guides/switching-networks))
